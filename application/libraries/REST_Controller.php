...
abstract class REST_Controller extends CI_Controller {
    ...
    {
        if ($this->request->format && in_array($this->request->format, ['json','xml']))
        {
           $this->request->body = $this->input->_raw_input_stream;
           $this->_put_args = (array) json_decode($this->input->_raw_input_stream);
        }
        else
        {
           // If no filetype is provided, then there are probably just arguments
           parse_str($this->input->_raw_input_stream,$this->_put_args);
        }
    }
    ...
    protected function _parse_patch()
    {
        ...
        {
           $this->request->body = $this->input->_raw_input_stream;
           $this->_patch_args = (array) json_decode($this->input->_raw_input_stream);
        }
        else
        {
           // If no filetype is provided, then there are probably just arguments
           parse_str($this->input->_raw_input_stream,$this->_patch_args);
        }
    }
    ...
    protected function _parse_delete()
    {
        ...
        {
            $this->_delete_args = is_array($this->input->input_stream()) ? $this->input->input_stream() : array();
        }
    }
    ...
    {
        $this->_query_args = is_array($this->input->get()) ? $this->input->get() : array();
    }
